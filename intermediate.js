...
//   // check string length against the max value
//   if (str.length > max) {
//       // if it is greater, slice it from the start to the max and concatenate the ...
...
// // Note: with these two I've added another.toFixed to see the right number of zeroes in the terminal, as it wasn't showing despite being the right value
